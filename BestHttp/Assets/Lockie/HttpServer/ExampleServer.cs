...
{
    public class ExamServer : HTTPServerLib.HttpServer
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        public ExamServer(string ipAddress, int port)
            : base(ipAddress, port)
        {
        ...
        //public override void OnGet(HttpRequest request, HttpResponse responseBase)
        //{
        //    //获取客户端传递的参数
        //    int num1 = int.Parse(request.Params["num1"]);
        //    int num2 = int.Parse(request.Params["num2"]);
