...
//		Facade.Instance.AddManager<ResourceManager>(ManagerName.Resource);
    ...
    public void CheckExtractResource() {
        ...
        //判断下当前有没网，有网更新下files，没网单机逻辑
        //StartCoroutine(OnUpdateResource());


        bool isExists = Directory.Exists(AppConst.DataPath) && File.Exists(AppConst.DataPath + "/AbBag/files.txt");
...
//            facade.SendMessageCommand(NotiConst.UPDATE_MESSAGE, message);
    ...
    IEnumerator OnUpdateResource() {
        ...
        string dataPath = AppConst.DataPath + "/AbBag";  //数据目录
